    ...
    <center>
        <div class="page" >
            <div class="main" style="font-size: 2em">     
                <center><b><h1>!!BEST OF LUCK FOR MOVIE QUIZ!!</h1></b></center><br>
                <form method="post" action="result.jsp">  
                    <%
                        ...
                        try {
                            ...
                            String sql = "select * from questions where subject='mq' order by RAND()";
                    ...
                    <input type="hidden" value="mq" name="sub">
                    <br>
